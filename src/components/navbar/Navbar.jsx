            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        <li><button onClick={() => handleHashNav('about')} className='btn btn-md btn-neutral btn-ghost w-full justify-center'>About</button></li>
                        <li><button onClick={() => handleHashNav('contact')} className='btn btn-md btn-neutral btn-ghost w-full justify-center'>Contact</button></li>
                    </ul>
                </div>
            </div>

            <div className='navbar-center flex items-center justify-center gap-2 sm:gap-3 group font-sans'>
                <SquareLibrary className="text-neutral w-6 h-6 sm:w-9 sm:h-9" />
                <Link to="/">
                    <span className="text-base sm:text-2xl font-bold text-neutral group-hover:text-[#457b9d] transition-colors">
                        <span className="hidden sm:inline">Islamic Research Center</span>
                        <span className="sm:hidden">IRC</span>
                    </span>
                </Link>
            </div>
            ...
            <div className="navbar-end flex items-center gap-2 sm:gap-4">
                {user ? (
                    <div className="dropdown dropdown-end dropdown-bottom">
                        ...
                        <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-50 w-60 p-2 shadow max-h-60">
                    ...
                    <Link
                        to="/login"
                        className="btn btn-neutral btn-sm sm:btn-md gap-2 transition-all"
                    >
